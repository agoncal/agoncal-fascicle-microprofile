package org.agoncal.fascicle.microprofile.jsonb.custom;
...
import static org.agoncal.fascicle.microprofile.jsonb.custom.UtilTest.initBufferedWriter;
import static org.agoncal.fascicle.microprofile.jsonb.custom.UtilTest.jsonPath;
import static org.agoncal.fascicle.microprofile.jsonb.custom.UtilTest.output;
...
public class BookTest {
  ...
  static void initFile() throws FileNotFoundException {
    bw = initBufferedWriter("src/main/java/org/agoncal/fascicle/microprofile/jsonb/custom/Book.json");
  }
